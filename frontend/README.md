...
- **Kế hoạch:** dùng **Tạo kế hoạch** hoặc **Nhập Excel** ở đầu danh sách để mở biểu mẫu; bấm tiêu đề biểu mẫu để thu gọn. Nhập số liệu từ văn bản đã duyệt, xem trước rồi lưu nháp. Duyệt phiên bản sau khi kiểm tra số văn bản và phạm vi. Bộ lọc kỳ/xí nghiệp nằm cùng nhóm, có số lượng phiên bản và nút **Bỏ bộ lọc** khi cần xem lại tất cả. Hỗ trợ tuần, tháng, quý, năm, khoảng ngày hoặc chuyến, chỉ tiêu tấn/TEU riêng; không có số kế hoạch giả lập trong ứng dụng.
